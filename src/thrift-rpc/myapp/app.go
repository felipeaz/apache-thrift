...
type UserService interface {
	Ping(ctx context.Context) (_r *PingResponse, _err error)
}
...
func (p *UserServiceClient) Ping(ctx context.Context) (_r *PingResponse, _err error) {
	var _args0 UserServicePingArgs
	var _result2 UserServicePingResult
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self4.processorMap["ping"] = &userServiceProcessorPing{handler: handler}
	return self4
}
...
func (p *userServiceProcessorPing) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 := p.handler.Ping(ctx); err2 != nil {
		...
		_exc7 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing ping: "+err2.Error())
...
func (p *UserServicePingResult) ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *UserServicePingResult) writeField0(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
